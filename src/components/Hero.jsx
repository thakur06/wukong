...
export const Hero = () => {
  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden scrollbar-none">
      {loading && (
      ...
      >
        <div>
          ...
          <video
            ...
            muted
            id="next-video"
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 invisible z-20 w-48 h-48 object-cover object-center"
            onLoadedData={handleVideoLoad}
          />
          <video
            src={getVideoSrc(
